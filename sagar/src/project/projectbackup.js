...
//                       <FormLabel style={{ fontSize: 20 }} name="gender" >Gender</FormLabel>
...
//                       </RadioGroup>
//                       <FormLabel style={{ fontSize: 20 }} name="qualification" >Qualification</FormLabel>

//                       <RadioGroup style={{ display: "initial" }} value={qualification} onChange={(e)=>{updateQualification(e.target.value)}} >
//                         <Radio value="10"  label="10" style={radio} control={<Radio/>} />
//                         <Radio value="12"  label="12" style={radio} control={<Radio/>} />
//                         <Radio value="graduation"  label="graduation" style={radio} control={<Radio/>} />
//                         <Radio value="phd"  label="phd" style={radio} control={<Radio/>} />
//                       </RadioGroup>
