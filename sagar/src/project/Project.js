            ...
            <Box >
                {emp ? <Box >
                    <Dialog open={open} PaperProps={{
                        ...
                        <DialogActions style={{ backgroundColor: "white", color: "white" }}>
                            <Button variant="contained" style={{ backgroundColor: "#eeeeee", color: "black" }} onClick={CloseUp}>Cancel</Button>
                            <Button color="success" variant="contained" onClick={handleClose} disabled={user.length === 0 || email.length === 0 || gender.length === 0 || qualification.length === 0 || profile.length === 0 || date.length === 0}>Submit</Button>
                        </DialogActions>
                    </Dialog>
